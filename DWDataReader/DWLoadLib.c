...
_DWGetMeasurementInfo DWGetMeasurementInfo;
...
_DWGetBinChannelListCount DWGetBinChannelListCount;
_DWGetBinChannelList DWGetBinChannelList;
_DWGetBinRecSamples DWGetBinRecSamples;
_DWGetBinData DWGetBinData;
...
_DWGetComplexChannelListItem DWGetComplexChannelListItem;
...
int LoadDWDLL(const char* lib_name)
{
	...
	if (!DWGetMultiFileIndex)
		return 0;
	DWGetMeasurementInfo = (_DWGetMeasurementInfo)GET_PROC_ADDRESS(hInstLibrary, "DWGetMeasurementInfo");
	if (!DWGetMeasurementInfo)
		return 0;
	...
	if (!DWGetBinarySamplesEx)
		return 0;
	DWGetBinChannelListCount = (_DWGetBinChannelListCount)GET_PROC_ADDRESS(hInstLibrary, "DWGetBinChannelListCount");
	if (!DWGetBinChannelListCount)
		return 0;
	DWGetBinChannelList = (_DWGetBinChannelList)GET_PROC_ADDRESS(hInstLibrary, "DWGetBinChannelList");
	if (!DWGetBinChannelList)
		return 0;
	DWGetBinRecSamples = (_DWGetBinRecSamples)GET_PROC_ADDRESS(hInstLibrary, "DWGetBinRecSamples");
	if (!DWGetBinRecSamples)
		return 0;
	DWGetBinData = (_DWGetBinData)GET_PROC_ADDRESS(hInstLibrary, "DWGetBinData");
	if (!DWGetBinData)
		return 0;
	...
	if (!DWGetChannelListItem)
		return 0;
	DWGetComplexChannelListItem = (_DWGetComplexChannelListItem)GET_PROC_ADDRESS(hInstLibrary, "DWGetComplexChannelListItem");
	if (!DWGetComplexChannelListItem)
		return 0;
