...
#pragma pack(1)
struct DWMeasurementInfo	    // structure used for measurement info
{
    double sample_rate;			// the sampling rate
    double start_measure_time;	// absolute time of the start of measurement (days)
    double start_store_time;	// absolute time of the start of storing (days)
    double duration;			// duration of data file (seconds)
};
...
typedef enum DWStatus(*_DWGetMeasurementInfo)(struct DWMeasurementInfo* file_info);
...
typedef int (*_DWGetBinChannelListCount) (void);
typedef enum DWStatus (*_DWGetBinChannelList) (struct DWChannel* channel_list);
typedef enum DWStatus (*_DWGetBinRecSamples) (int ch_index, __int64 sampleIndex, int count, struct TBinaryData* data, double* time_stamp);
typedef enum DWStatus (*_DWGetBinData) (int ch_index, struct TBinaryData* sample, char* data, __int64* absPos, int binBufSize);
...
typedef enum DWStatus (*_DWGetComplexChannelListItem)(int array_index, int* index, char* name, char* unit, char* description, int* color, int* array_size, int max_char_size);
...
extern _DWGetMeasurementInfo DWGetMeasurementInfo;
...
extern _DWGetBinChannelListCount DWGetBinChannelListCount;
extern _DWGetBinChannelList DWGetBinChannelList;
extern _DWGetBinRecSamples DWGetBinRecSamples;
extern _DWGetBinData DWGetBinData;
...
extern _DWGetComplexChannelListItem DWGetChannelListItem;
